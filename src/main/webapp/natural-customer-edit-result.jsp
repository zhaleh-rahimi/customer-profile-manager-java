        ...
        <div class="layer">
            <div class="layer-in">
                ...
                <%
                    ...
                    MessageUtil errorMessageUtil = (MessageUtil) request.getAttribute("error");
                %>
                <h2 style="color: #b80000"><%=errorMessageUtil.getHeader()%>
                </h2>
                <h3 style="color: #b80000"><%=errorMessageUtil.getInfo()%>
                </h3>
                <%}%>
